...
const LeftLinks = [
    ...
    { label: "Projects", link: "/projects", src: "/assets/videos/menu/projects.mp4" },
    { label: "Gallery", link: "/our-gallery", src: "/assets/videos/menu/gallery.mp4" },
    { label: "Blogs", link: "/blogs", src: "/assets/videos/menu/blogs.mp4" },
    { label: "Contact", link: "/contact-us", src: "/assets/videos/menu/contact.mp4" },
];

const RightLinks = [
    { label: "About", link: "/about-us", src: "/assets/videos/menu/about-us.mp4" },
    { label: "Media Center", link: "/media-center", src: "/assets/videos/menu/media.mp4" },
    { label: "CSR", link: "/csr", src: "/assets/videos/menu/csr.mp4" },
    { label: "Career", link: "/career", src: "/assets/videos/menu/career.mp4" },
    { label: "Investors Corner", link: "/investors", src: "/assets/videos/menu/investors.mp4" },
];
...
const SocialMediaLinks = [
    ...
    { icon: <FaInstagram />, link: "https://www.instagram.com/ashwinshethgroupltd/" },
    { icon: <AiOutlineYoutube />, link: "https://www.youtube.com/channel/UCW7PBDljlbTw1c1vB9QuDuQ" },
    { icon: <FaLinkedinIn />, link: "https://www.linkedin.com/company/ashwin-sheth-group/" },
];
    ...
    return (
      ...
      flex overflow-hidden translate-x-full"
        >
            ...
            <div className="flex flex-col gap-[20px] pt-[30px] md:pt-[50px] md:justify-between w-full md:w-2/3 px-[20px] md:pl-20 py-[20px]  overflow-y-auto relative">
                <div className="relative">
                    <button
                        onClick={() => setIsOpen(false)}
                        className="cursor-pointer text-[30px] absolute right-[0px] md:right-[0px] top-[-15px] md:-top-[20px] "
                    >
                        <IoMdClose />
                    </button>
                    <div className="flex gap-[5px] md:gap-[40px]">
                        {/* LEFT  LINKS */}
                        <div className="w-full space-y-[20px] md:space-y-[15px]">
                            {Links.map((item, i) => (
                                <div key={i} className="group w-fit hover:w-full">
                                    {item.link ?
                                        <Link
                                            onClick={() => setIsOpen(false)} href={`/${item.link}`} className="block w-fit"><Heading className={`${i === 0 ? "text-[#F58220]" : "text-black"} hover:text-[#F58220] text-left text-[18px] md:!text-[22px]`}>{item.label}</Heading></Link>
                                        : <Heading
                                            onClick={() => setIsOpen(false)} className={`w-fit mb-[10px] group-hover:mb-[0px] ${i === 0 ? "text-[#F58220]" : "text-black"} hover:text-[#F58220] text-left text-[18px md:!text-[22px]`}>{item.label}</Heading>
                                    }
                                    {item.subLinks &&
                                        <ul
                                            className={`
                                        ...
                                        >
                                            ...
                                            {item.subLinks?.map((child, j) => (
                                                ...
                                                >
                                                    ...
                                                    <Link
                                                        onClick={() => setIsOpen(false)} href={`/${child.link}`}
                                                    ...
                                                    {j !== item.subLinks.length - 1 && <span className="ml-[5px] md:ml-[10px]">|</span>}
                                                </li>
                                            ))}
                ...
                <div>
                    <Heading className="text-black/30 md:!text-[22px] text-start mt-[20px] md:mt-0 mb-[10px]">
                        Get In Touch
                    </Heading>
                ...
                <div>
                    <Heading className="text-black/30 md:!text-[22px] text-start mt-[20px] md:mt-0 mb-[20px]">
                        Stay Connected
                    </Heading>
